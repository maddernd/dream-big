...
ActiveRecord::Schema[7.0].define(version: 2022_11_13_035136) do
  ...
  create_table "avatars", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.bigint "avatar_torso_id"
    t.bigint "avatar_hair_id"
    t.bigint "avatar_accessory_id"
    t.bigint "student_id"
    t.index ["avatar_accessory_id"], name: "fk_rails_e238e2496e"
    t.index ["avatar_hair_id"], name: "fk_rails_b2b3594004"
    t.index ["avatar_head_id"], name: "fk_rails_a8fde6201d"
    t.index ["avatar_torso_id"], name: "fk_rails_9288120d7c"
    t.index ["student_id"], name: "fk_rails_e50b96f495"
  end
  ...
  add_foreign_key "avatars", "avatar_accessories"
  add_foreign_key "avatars", "avatar_hairs"
  add_foreign_key "avatars", "avatar_heads"
  add_foreign_key "avatars", "avatar_torsos"
  add_foreign_key "avatars", "students"
